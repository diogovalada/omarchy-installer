...
Date: 2026-09-07. Status: the two-action flow and a bounded keep-files
profile are implemented; automatic boot restoration is deferred in the Windows community preview. See the
