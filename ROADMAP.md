...
USB creation offers **Keep files and add installer** for the bounded Windows x64
GPT/NTFS plus FAT32 EFI profile and **Erase USB and create installer**. Existing
bootloaders are backed up before replacement. Only **Restore previous boot setup**
remains deferred; its historical code is retained in [the archive](archive/usb-preserve-2026-09-07/README.md).
See [current scope and qualification](docs/usb-preserve-implementation-2026-09-07.md).
