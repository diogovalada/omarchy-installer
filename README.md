...
Development and physical testing status, grouped by the operating system running
the app. Implementation details are listed in the support matrix above.

❌ In Development · ⚠️ Needs Testing · ✅ Tested
